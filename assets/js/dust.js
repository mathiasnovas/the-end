...
AFRAME.registerComponent('dust', {
    ...
    createSpecks: function () {
        ...
        for ( let i = 0; i < data.numPoints; i ++ ) {
            ...
            const x = THREE.MathUtils.randFloatSpread( data.dispersion * 1.9 );
            const y = THREE.MathUtils.randFloatSpread( data.dispersion * 1.9 );
            const z = THREE.MathUtils.randFloatSpread( data.dispersion * 1.9 );
    ...
    moveSpecks: function (time) {
        ...
        for (let i=8; i<this.vertices.length; ++i) {
